...
const api: DesktopApi = {
  ...
  ) => invoke(IPC_CHANNELS.createRunPullRequest, runId, targetBranch, title, sourceBranchName, description, commitMessage),
  suggestRunPullRequestDraft: (runId: string, targetBranch: string) =>
    invoke(IPC_CHANNELS.suggestRunPullRequestDraft, runId, targetBranch),
  ...
  updateProjectBaseBranch: (projectId: string, branchName: string) =>
    invoke(IPC_CHANNELS.updateProjectBaseBranch, projectId, branchName),
  ...
  exportDataBackup: (input: DataBackupExportInput) => invoke(IPC_CHANNELS.exportDataBackup, input),
  selectDataBackupForImport: () => invoke(IPC_CHANNELS.selectDataBackupForImport),
  importDataBackup: (input: DataBackupImportInput) => invoke(IPC_CHANNELS.importDataBackup, input),
