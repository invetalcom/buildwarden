...
const TAB_CONFIG: Array<{ id: SettingsTab; label: string; icon: React.ReactNode }> = [
  ...
  { id: "orchestration", label: "Orchestration", icon: <UsersRound className="h-4 w-4" /> },
    ...
    <div className="flex h-full min-h-0 overflow-hidden rounded-lg border border-[var(--ec-border)] bg-[var(--ec-panel)]">
      ...
      {activeTab === "git-workspace" ? (
        <GitWorkspaceSettingsTab
          ...
          onConsecutiveToolCallCollapseThresholdChange={onConsecutiveToolCallCollapseThresholdChange}
